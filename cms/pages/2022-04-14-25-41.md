...
content:
  ...
  - type: marketing/discover
    label:
      ...
      component: p
    title:
      value: 1 - CEWE, la meilleure qualitée
      component: h2
    description: "Elu meilleur service d'impression photo au monde depuis 4 ans,
      CEWE c'est LE site de top qualité. Facile d'utilisation, le site propose
      de nombreuses options (couvertures, finitions,...) et des produits très
